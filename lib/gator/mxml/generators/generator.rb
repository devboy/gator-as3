module Gator
  module MXML
    class MXMLGenerator < Gator::Generator
      ...
      def target
        File.join(source, AS3Util.package_to_dir(@package_name), "#{@class_name}.mxml")
      end

    end

    class KlassGenerator < MXMLGenerator
    ...
    class TestGenerator < MXMLGenerator
